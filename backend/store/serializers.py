...
class ProductListVendorSerializer(serializers.ModelSerializer):
    """Minimal vendor payload for product list cards (name, slug, link)."""
...
class ProductListSerializer(serializers.ModelSerializer):
    """List/featured products without gallery, variants, or heavy nested trees."""

    image = AbsoluteMediaField(read_only=True, allow_null=True)
    vendor = ProductListVendorSerializer(read_only=True)
