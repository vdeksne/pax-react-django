                              ...
                              {loading === true && (
                                <>
                                  <div className="border border-3 border-warning">
                                    <div className="card bg-white shadow p-5 d-flex flex-column justify-content-center align-items-center">
                                    ...
                                    <div className="border border-3 border-success">
                                      <div className="card bg-white shadow p-5 d-flex flex-column justify-content-center align-items-center">
                                        ...
                                        <div className="text-center">
                                          ...
                                          <div className="settings-buttons-container-main d-flex flex-row gap-2">
                                            <button
                                              className="btn-main-pricing mt-3 me-2"
                                    ...
                                    <div className="border border-3 border-success">
                                      <div className="card bg-white shadow p-5 d-flex flex-column justify-content-center align-items-center">
                                        ...
                                        <div className="text-center">
                                          <h1>Thank You !</h1>
                                          <p>
                                            Your checkout was successfull, we
