          ...
          <main className="mt-5">
            <div className="container">
              <section className="text-center container">
                <img
                  src="https://images.unsplash.com/photo-1585499583264-491df5142e83?q=80&w=1800&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                  alt=""
                  style={{
                    width: "100%",
                    height: "100%",
                ...
                <div className="row mt-4 mb-3">
                  <div className="col-lg-6 col-md-8 mx-auto">
                    <h1 className="fw-light">Product Categories</h1>
                  </div>
                </div>
              </section>
