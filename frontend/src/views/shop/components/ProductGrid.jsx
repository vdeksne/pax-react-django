                    ...
                    {product.color?.length > 0 || product.size?.length > 0 ? (
                            ...
                            <div className="p-1 mt-0 pt-0 d-flex flex-wrap">
                              <li>
                                <input
                                  ...
                                  value={
                                    qtyValue &&
                                    typeof qtyValue === "object" &&
                                    qtyValue[product.id] !== undefined
                                      ? qtyValue[product.id]
                                      : qtyValue || 1
                                  }
                                />
                            ...
                            product.color.length > 0 && (
                              <div className="d-flex flex-column mt-3">
                                <li className="p-1 color_name_div">
                                  <b>Color</b>:{" "}
                                  {selectedColors && selectedColors[product.id]
                      ...
                      >
                        ...
                        loadingStates[product.id] === "Added to Cart" ? (
                          ...
                          <>
                            {(loadingStates && loadingStates[product.id]) ||
                              "Add to Cart"}{" "}
                            <FaShoppingCart />
                          </>
                        )}
...
ProductGrid.propTypes = {
  ...
  handleColorButtonClick: PropTypes.func.isRequired,
  handleSizeButtonClick: PropTypes.func.isRequired,
  handleQtyChange: PropTypes.func.isRequired,
  handleAddToCart: PropTypes.func.isRequired,
  handleAddToWishlist: PropTypes.func.isRequired,
  selectedProduct: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
  colorImage: PropTypes.string,
  selectedColors: PropTypes.object,
  selectedSize: PropTypes.object,
  qtyValue: PropTypes.oneOfType([
    PropTypes.number,
    PropTypes.object, // for per-product quantity state shape
  ]),
